 ...
 // user.guild.channels.cache.get("812061099653988413").send("SomeText")
    ...
    client.on('ready', () => {
      console.log('Bot is now connected')
        ...
        client.channels.find(channel => channel.name === 'bot').send("> 📚 Readme for this bot: <https://github.com/vaido-world/levelup-discord-bot>"); 
        client.channels.find(channel => channel.name === 'bot').send("> 🗄 Heroku, Control Panel: <https://dashboard.heroku.com/apps/levelup-discord-bot/deploy/github>"); 
        client.channels.find(channel => channel.name === 'bot').send("> 🧵 MongoDB database: <https://www.mongodb.com/>"); 
        client.channels.find(channel => channel.name === 'bot').send("> 📓 Discord Settings for this Bot: <https://discord.com/developers/applications/804719647601459250/bot>"); 
